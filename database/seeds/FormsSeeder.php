...
class FormsSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      DB::table("forms")->insert([
         "id" => "19",
         "name" => "Evaluación de la acción tutorial",
