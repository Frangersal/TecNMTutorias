...
class QuestionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table("questions")->insert([ "id"=>"13","name"=>"Codigo Postal","form_id"=>"1","answer_type_id"=>"1",]);
        ...
        DB::table("questions")->insert([ "id"=>"50","name"=>"A cuanto ascienden los ingresos mensuales de tu familia","form_id"=>"3","answer_type_id"=>"1",]);
        DB::table("questions")->insert([ "id"=>"51","name"=>"En caso de ser económicamente independiente a cuanto asciende tu ingreso","form_id"=>"3","answer_type_id"=>"1",]);
        ...
        DB::table("questions")->insert([ "id"=>"57", "name"=>"Dolores en el cientre","form_id"=>"5", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"63", "name"=>"Pesadillas o terroes nocturnos a que:","form_id"=>"5", "answer_type_id"=>"2",]);
        DB::table("questions")->insert([ "id"=>"64", "name"=>"Incontinencia (orina, heces)","form_id"=>"5", "answer_type_id"=>"2",]);
        DB::table("questions")->insert([ "id"=>"65", "name"=>"Tartamudeos al esplicarse","form_id"=>"5", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"69","name"=>"¿De que tipo?","form_id"=>"6","answer_type_id"=>"1",]);
        DB::table("questions")->insert([ "id"=>"70","name"=>"¿Qué actitud tienes con tu familia?","form_id"=>"6","answer_type_id"=>"1",]);
        DB::table("questions")->insert([ "id"=>"71","name"=>"¿Cómote relacionas con tu Padre?","form_id"=>"6","answer_type_id"=>"1",]);
        DB::table("questions")->insert([ "id"=>"72","name"=>"¿Qué actitud tienes hacia tu Padre?","form_id"=>"6","answer_type_id"=>"1",]);
        DB::table("questions")->insert([ "id"=>"73","name"=>"¿Cómote relacionas con tu Madre?","form_id"=>"6","answer_type_id"=>"1",]);
        ...
        DB::table("questions")->insert([ "id"=>"86","name"=>"Especificar por que","form_id"=>"8","answer_type_id"=>"1",]);
        DB::table("questions")->insert([ "id"=>"87", "name"=>"¿Quién se ocupa más directamente de tu educación?","form_id"=>"8", "answer_type_id"=>"2",]);
        DB::table("questions")->insert([ "id"=>"88","name"=>"¿Quién ha influido más en tu descisión para estudiar esta carrera?","form_id"=>"8","answer_type_id"=>"1",]);
        ...
        DB::table("questions")->insert([ "id"=>"127","name"=>"Mendiona las asignaturas que cursas en el semestre actual.","form_id"=>"11","answer_type_id"=>"1",]);
        DB::table("questions")->insert([ "id"=>"128","name"=>"¿Cuál es tu asignatura preferia? ¿Por qué?","form_id"=>"11","answer_type_id"=>"1",]);
        ...
        DB::table("questions")->insert([ "id"=>"157", "name"=>"¿Está situado tu escritorio directamiente en frente a una ventana, puerta u otra fuente de distracción?","form_id"=>"14", "answer_type_id"=>"2",]);
        DB::table("questions")->insert([ "id"=>"158", "name"=>"¿Sueles tiener fotografía, trofeos o recuerdos sobre tu mesa de cómodo?","form_id"=>"14", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"161", "name"=>"Tu mesa de estudio ¿está tan desordenada y llena de objetos, que no dispones de sitio suficiente para estudiar con eficacía?","form_id"=>"14", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"166", "name"=>"¿Sueles hacerse lento tu estudio debido a que no tienens a la mano los libroy los maeriales necesarios?","form_id"=>"14", "answer_type_id"=>"2",]);
        DB::table("questions")->insert([ "id"=>"167", "name"=>"¿Tiendes a comenzar la lectura de un libro de texto sin hojear previamente los subtitulos y las ilustraciones?","form_id"=>"15", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"169", "name"=>"¿Suele serte dificil seleccionar los puntos de los temas de estudio?","form_id"=>"15", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"171", "name"=>"¿Sueles tener dificultad en entender tus apuntes de clase cuando tratas de repasarlos, despúes de cierto tiempo?","form_id"=>"15", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"176", "name"=>"¿Te es dificil preparar un temario de una evaluación formulas un resumen de este?","form_id"=>"15", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"180", "name"=>"¿Te resulta dificil decidir qué estudiar y cómo estudiarlo cuando preparas un evaluación?","form_id"=>"15", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"184", "name"=>"¿Te es posible con frecuencia terminar una evaluación de esposición de un tema en el tiempo prescrito?","form_id"=>"15", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"191", "name"=>"¿Crees que es mas importante divertirte y disfrutar de la vida, que estudiar?","form_id"=>"16", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"198", "name"=>"¿Te horroriza estudiar libros de textos porque son insipidos y aburridos?","form_id"=>"16", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"200", "name"=>"¿Sueles pensar que los exámenes son pruebas penosas de las que no se puede escapar y respecto a las cuales lo que debe hacerse es sobrecicir, del modo que sea?","form_id"=>"16", "answer_type_id"=>"2",]);
        DB::table("questions")->insert([ "id"=>"201", "name"=>"¿Sientes con frecuencia que tus docientes no comprenden las necesidades de los estudiantes?","form_id"=>"16", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"211", "name"=>"En tu lugar de tabajo o de estudios, se está explicando algo que es completamente nuevo para ti. Llega un momento en que te das cuenta que no has entendido casi nada ¿qué haces?","form_id"=>"17", "answer_type_id"=>"2",]);
        DB::table("questions")->insert([ "id"=>"212", "name"=>"Tener un trabajo bien remunerado y que nos guste es algo dificil de conseguir, si tuvieras que valorar tu empreo o situacion laboral, ¿cómo la definirías?","form_id"=>"17", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"216", "name"=>"En una fiesta en la que no conocess a nadie excepto a los anfitriones, te presentan a un grupo de personas de aspecto interesante. ¿Cuál es tu actitud?","form_id"=>"17", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"226", "name"=>"Tengo toda la informaciónnecesaria sobre el programa de tutoriá de mi plantel.","form_id"=>"19", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"230", "name"=>"La programación de asignatudas en la carreda de mis tutorados les permite asistir a las actividades de apoyo y/o cursos de mejora programados.","form_id"=>"19", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"232", "name"=>"Tengo buena comunicación con la coordinacion de tutoría.","form_id"=>"19", "answer_type_id"=>"2",]);
        ...
        DB::table("questions")->insert([ "id"=>"236", "name"=>"En mi plantel existe la actualización permanente en tuanto al programa de tuotoría.","form_id"=>"19", "answer_type_id"=>"2",]);
